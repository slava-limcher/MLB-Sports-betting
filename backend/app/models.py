...
class PlacedBet(BaseModel):
    ...
    line: Optional[float] = None  # spread/total line, needed to settle
...
class UserSession(BaseModel):
    alias: str
    team: Optional[TeamAffiliation] = None
    favorite_player_id: Optional[int] = None
    favorite_player_name: Optional[str] = None
    balance: float = 1000.0       # fake-money bankroll
    wins: int = 0
    losses: int = 0
    streak: int = 0               # +n win streak / -n loss streak
